...
public class NVPAPICaller
{
    ...
    public string APIUsername = "nekaras-facilitator_api1.hotmail.com";
    private string APIPassword = "GVWW7LBTW7VUYL3B";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A-.k9OrQsOpY.A.7oo4IBAn.h-LE";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:58111/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:58111/Checkout/CheckoutCancel.aspx";
